...
describe('useShortcuts', () => {
    ...
    it('should accept a array config of keys and fn and call the events', () => {
        const keyObj = {fn: jest.fn()}
        const spy = jest.spyOn(keyObj, 'fn')
        const wrapper = ({ children }: { children?: React.ReactNode }) => <ShortcutProvider>{children}</ShortcutProvider>
